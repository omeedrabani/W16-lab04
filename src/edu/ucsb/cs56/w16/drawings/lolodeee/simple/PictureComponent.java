package edu.ucsb.cs56.w16.drawings.lolodeee.simple;
...
/**
   ...
   @author Lauren Dumapias (fixed the snowmans's head)
...
{  
    ...
    {  
	 ...
	 Circle snowManTopCircle = 
        ...
        g2.drawString("Do you want to build a snowman? By: Lauren Dumapias", 20,20);
