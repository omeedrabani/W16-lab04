package edu.ucsb.cs56.w16.drawings.nicolemoghaddas.simple;
...
/**
   ...
   @author Nicole Moghaddas (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
         ...
         g2.drawString("Snowman has his head! Nicole Moghaddas", 20,20);
