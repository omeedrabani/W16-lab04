package edu.ucsb.cs56.w16.drawings.sarahmzhong;
...
public class SimpleGui1 {
    ...
    */
	...
	JButton button = new JButton("Poke the Window") ;
	
	java.awt.Color myColor = new java.awt.Color(070,255,230);   // R, G, B values.
